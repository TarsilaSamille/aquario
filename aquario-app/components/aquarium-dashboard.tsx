      ...
      <div className="container mx-auto p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-2xl font-semibold">
                {ph !== null ? ph.toFixed(2) : "Carregando..."}
              </p>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-2xl font-semibold">
                {amonia !== null ? `${amonia} ppm` : "Carregando..."}
              </p>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-2xl font-semibold">
                {luminosity !== null ? `${luminosity} lux` : "Carregando..."}
              </p>
              <p className="text-sm text-muted-foreground">
                Ideal: 200-400 lux
              </p>
            ...
            <CardContent className="space-y-2">
              ...
              {showFeedError && (
                <p className="text-red-500 text-sm mt-2">
                  Você só pode alimentar os peixes uma vez por dia!
                </p>
              )}
              ...
              {/* Troca de Água */}
              <Button
                className="w-full justify-start bg-blue-500 text-white"
        ...
        {showAutoFeedPopup && (
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white p-6 rounded-lg shadow-lg text-black">
              <p>
                {autoFeed
                  ? "Alimentação Automática Ativada"
                  : "Alimentação Automática Desativada"}
              </p>
